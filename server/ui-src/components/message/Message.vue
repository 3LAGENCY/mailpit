...
import FlagPopup from "./FlagPopup.vue";
  ...
  methods: {
    isHTMLTabSelected: function () {
      this.showMobileButtons =
        this.$refs.navhtml && this.$refs.navhtml.classList.contains("active");
    },
    ...
    textToHTML: function (s) {
      ...
      html = html.replace(
        re,
        "˱˱˱a href=ˠˠˠ$&ˠˠˠ target=_blank rel=noopener˲˲˲$&˱˱˱/a˲˲˲"
      );
    ...
    handleReportPhishing() {
      axios
        .post(this.resolve("/api/v1/report/phishing"), {
    ...
    handleReportApprove() {
      axios
        .post(this.resolve("/api/v1/report/approve"), {
          email: this.message.From.Address,
        })
        .then((response) => {
          this.clearBlur();
  ...
  >
        ...
        <table class="messageHeaders">
          <tbody>
              ...
              <td class="privacy">
                <span v-if="message.From">
                  ...
                  <span v-if="message.From.Address" class="small">
                    &lt;<a
                      :href="searchURI(message.From.Address)"
                      class="text-body"
                    >
                ...
                >
                  ...
                  <i
                    ...
                    :class="{
                      'text-danger': message.ListUnsubscribe.Errors != '',
                    }"
                  ></i>
                </span>
              </td>
            ...
            <tr class="small">
              ...
              <td class="privacy">
                <span
                  v-if="message.To && message.To.length"
                  v-for="(t, i) in message.To"
                >
            ...
            <tr
              v-if="
                message.ReturnPath &&
                message.From &&
                message.ReturnPath != message.From.Address
              "
              class="small"
            >
              ...
              <td class="privacy text-body-secondary text-break">
                &lt;<a
                  :href="searchURI(message.ReturnPath)"
                  class="text-body-secondary"
                >
            ...
            <tr>
              ...
              <td>
                <strong v-if="message.Subject != ''" class="text-spaces">{{
                  message.Subject
                }}</strong>
            ...
            >
              ...
              <td>
                <span
                  v-if="message.ListUnsubscribe.Links.length"
                  class="text-secondary small me-2"
                >
                ...
                <i
                  ...
                  :data-bs-title="
                    ...
                    message.ListUnsubscribe.HeaderPost
                  "
                >
                </i>
                <i
      ...
      >
        <template v-if="message.HTML">
          ...
          <button
            ...
            aria-selected="false"
          >
            HTML <span class="d-sm-none">Src</span
            ...
            <li v-if="mailbox.showLinkCheck">
              ...
              >
                ...
                <span
                  ...
                  v-if="linkCheckErrors === 0"
                >
                  <small>0</small>
                </span>
                <span
                  class="badge rounded-pill bg-danger float-end"
                  v-else-if="linkCheckErrors > 0"
                >
    ...
    <div class="tab-content mb-5" id="nav-tabContent">
      ...
      >
        <div
          id="responsive-view"
          :class="scaleHTMLPreview"
          :style="responsiveSizes[scaleHTMLPreview]"
        >
          <iframe
            target-blank=""
